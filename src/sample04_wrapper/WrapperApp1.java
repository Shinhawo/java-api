...
public class WrapperApp1 {
	...
	public static void main(String[] args) {
		...
		// Wrapper의 toString() -> 값이 출력된다. 문자열로 반환된다. 
		// Boolean에 재정의된 toString()의 반환값이 출력된다.
